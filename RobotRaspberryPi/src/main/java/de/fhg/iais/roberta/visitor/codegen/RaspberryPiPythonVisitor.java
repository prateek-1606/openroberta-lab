...
public final class RaspberryPiPythonVisitor extends AbstractPythonVisitor implements IRaspberryPiVisitor<Void> {
    ...
    public Void visitLightStatusAction(LightStatusAction<Void> lightStatusAction) {
        this.sb.append("rgb_led_" + lightStatusAction.getPort() + ".off()");
        return null;
    }
    ...
    public Void visitSmoothedSensor(SmoothedSensor<Void> smoothedSensor) {
        this.sb.append("smoothed_input_" + smoothedSensor.getPort() + "." + smoothedSensor.getMode().toLowerCase());
        return null;
    }
    ...
    public Void visitUltrasonicSensor(UltrasonicSensor<Void> ultrasonicSensor) {
        this.sb.append("distance_sensor_" + ultrasonicSensor.getPort() + ".distance");
        return null;
    }

    @Override
    public Void visitLightSensor(LightSensor<Void> lightSensor) {
        this.sb.append("light_sensor_" + lightSensor.getPort() + "." + lightSensor.getMode().toLowerCase());
        return null;
    }

    @Override
    public Void visitMotionSensor(MotionSensor<Void> motionSensor) {
        this.sb.append("motion_sensor_" + motionSensor.getPort() + ".motion_detected");
        return null;
    }

    @Override
    public Void visitKeysSensor(KeysSensor<Void> keysSensor) {
        this.sb.append("button_" + keysSensor.getPort() + ".is_pressed");
        return null;
    }

    @Override
    public Void visitPinGetValueSensor(PinGetValueSensor<Void> pinGetValueSensor) {
        this.sb.append("digital_input_" + pinGetValueSensor.getPort() + ".value");
        return null;
    }
    ...
    public Void visitToneAction(ToneAction<Void> toneAction) {
        this.sb.append("buzzer_").append(toneAction.getPort()).append(".play(gpz.tones.Tone(");
